...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AppComponent = /*#__PURE__*/function () {
      ...
      _createClass(AppComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {} // @HostListener('window:keydown', ['$event'])
        ...
        value: function setFlag() {
          ...
          this.displayCateringFlag = String(this.printTktResp.displayCateringFlag); //this.gstFlag='true';
        }
      }, {
        key: "informationMessages",
        get: function get() {
          return Array.isArray(this.printTktResp.ticketLegendMessage) ? this.printTktResp.ticketLegendMessage : Array.of(this.printTktResp.ticketLegendMessage);
        }
      }, {
        key: "psgnDtlList",
        get: function get() {
          return Array.isArray(this.printTktResp.passengerList) ? this.printTktResp.passengerList : Array.of(this.printTktResp.passengerList);
        }
      }, {
        key: "topTktMsg",
        get: function get() {
          return Array.isArray(this.printTktResp.topTicketMessage) ? this.printTktResp.topTicketMessage : Array.of(this.printTktResp.topTicketMessage);
        }
      }, {
        key: "bottomTktMsg",
        get: function get() {
          return Array.isArray(this.printTktResp.bottomTicketMessage) ? this.printTktResp.bottomTicketMessage : Array.of(this.printTktResp.bottomTicketMessage);
        }
      }, {
        key: "fundmntlTktMsg",
        get: function get() {
          return Array.isArray(this.printTktResp.fundmntlTicketMessage) ? this.printTktResp.fundmntlTicketMessage : Array.of(this.printTktResp.fundmntlTicketMessage);
        }
      }, {
        key: "fareInfoData",
        get: function get() {
          return Array.isArray(this.printTktResp.fareInfoData) ? this.printTktResp.fareInfoData : Array.of(this.printTktResp.fareInfoData);
        }
      }, {
        key: "CancellationRefundData",
        get: function get() {
          return Array.isArray(this.printTktResp.cancelFareDetail) ? this.printTktResp.cancelFareDetail : Array.of(this.printTktResp.cancelFareDetail);
        }
      }, {
        key: "processData",
        value: function processData() {
          ...
          this.printTktInput = '';
          this.printPopup = false; //console.log(this.printTktResp);

          this.accommodationStatus = this.printTktResp.accommodationStatus;
          this.passengerList = Array.isArray(this.printTktResp.passengerList) ? this.printTktResp.passengerList : Array.of(this.printTktResp.passengerList);
          ...
          var _iterator = _createForOfIteratorHelper(this.passengerList),
              _step;

          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              var psgn = _step.value;
          ...
          var _iterator2 = _createForOfIteratorHelper(this.passengerList),
              _step2;

          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              var _psgn = _step2.value;

              if (_psgn.passengerConcession == 'MPPASS' || _psgn.passengerConcession == 'EXMP') {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var angular2_qrcode__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! angular2-qrcode */
    "./node_modules/angular2-qrcode/lib/angular2-qrcode.js");
    /* harmony import */


    var _pipe_rupees_in_words_pipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./pipe/rupees-in-words.pipe */
    "./src/app/pipe/rupees-in-words.pipe.ts");
    /* harmony import */


    var _pipe_rupees_in_hindi_pipe__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./pipe/rupees-in-hindi.pipe */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _pipe_rupees_in_words_pipe__WEBPACK_IMPORTED_MODULE_5__["RupeesInWordsPipe"], _pipe_rupees_in_hindi_pipe__WEBPACK_IMPORTED_MODULE_6__["RupeesInHindiPipe"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], angular2_qrcode__WEBPACK_IMPORTED_MODULE_4__["QRCodeModule"], primeng_inputtextarea__WEBPACK_IMPORTED_MODULE_7__["InputTextareaModule"], primeng_inputtext__WEBPACK_IMPORTED_MODULE_8__["InputTextModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_9__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_9__["ReactiveFormsModule"]],
  ...
  /***/
  function srcAppPipeRupeesInHindiPipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RupeesInHindiPipe", function () {
      return RupeesInHindiPipe;
    });
    /* harmony import */
    ...
    var RupeesInHindiPipe = /*#__PURE__*/function () {
      function RupeesInHindiPipe() {
        _classCallCheck(this, RupeesInHindiPipe);

        this.a = ['', 'एक ', 'दो ', 'तीन ', 'चार ', 'पांच ', 'छह ', 'सात ', 'आठ ', 'नौ ', 'दस ', 'ग्यारह ', 'बारह ', 'तेरह ', 'चौदह ', 'पंद्रह ', 'सोलह ', 'सत्रह ', 'अठारह ', 'उन्नीस ', ' बीस', ' इक्कीस', ' बाईस', ' तेईस', ' चौबीस', ' पच्चीस', ' छब्बीस', ' सत्ताईस', ' अट्ठाईस', ' उनतीस', ' तीस', ' इकतीस', ' बत्तीस', ' तैंतीस', ' चौंतीस', ' पैंतीस', ' छत्तीस', ' सैंतीस', ' अड़तीस', ' उनतालीस', ' चालीस', ' इकतालीस', ' बयालीस', ' तैंतालीस', ' चवालीस', ' पैंतालीस', ' छियालीस', ' सैंतालीस', ' अड़तालीस', ' उनचास', ' पचास', ' इक्यावन', ' बावन', ' तिरपन', ' चौवन', ' पचपन', ' छप्पन', ' सत्तावन', ' अट्ठावन', ' उनसठ', ' साठ', ' इकसठ', ' बासठ', ' तिरसठ', ' चौंसठ', ' पैंसठ', ' छियासठ', ' सरसठ', ' अड़सठ', ' उनहत्तर', ' सत्तर', ' इकहत्तर', ' बहत्तर', ' तिहत्तर', ' चौहत्तर', ' पचहत्तर', ' छिहत्तर', ' सतहत्तर', ' अठहत्तर', ' उनासी', ' अस्सी', ' इक्यासी', ' बयासी', ' तिरासी', ' चौरासी', ' पचासी', ' छियासी', ' सत्तासी', ' अट्ठासी', ' नवासी', ' नब्बे', ' इक्यानबे', ' बानवे', ' तिरानवे', ' चौरानबे', ' पंचानवे', ' छियानबे', ' सत्तानवे', ' अट्ठानबे', ' निन्यानवे'];
        this.b = ['', '', 'बीस', 'तीस', 'चालीस', 'पचास', 'साठ', 'सत्तर', 'अस्सी', 'नव्वे'];
      }

      _createClass(RupeesInHindiPipe, [{
        key: "transform",
        ...
        value: function inWords(num) {
          ...
          str += Number(n[5]) !== 0 ? (str !== '' ? '' : '') + (this.a[Number(n[5])] || this.b[n[5][0]] + ' ' + this.a[n[5][1]]) + ' ' : '';
          return str;
        }
      }]);
    ...
    RupeesInHindiPipe = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({
      name: 'rupeesInHindi'
    })], RupeesInHindiPipe);
    /***/
  },
  ...
  /***/
  function srcAppPipeRupeesInWordsPipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RupeesInWordsPipe", function () {
      return RupeesInWordsPipe;
    });
    /* harmony import */
    ...
    var RupeesInWordsPipe = /*#__PURE__*/function () {
      function RupeesInWordsPipe() {
        _classCallCheck(this, RupeesInWordsPipe);
      ...
      _createClass(RupeesInWordsPipe, [{
        key: "transform",
        value: function transform(value, args) {
          var decimal;
          var fraction;
    ...
    RupeesInWordsPipe = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({
      name: 'rupeesInWords'
    })], RupeesInWordsPipe);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! F:\workspace\print-ticket\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
